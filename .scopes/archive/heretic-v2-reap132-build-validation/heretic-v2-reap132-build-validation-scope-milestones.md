...
# heretic-v2-reap132-build-validation Scope and Milestones (Archived)

## Closeout

All three phases are complete. The native checkpoint is accepted with its
bounded native-HF CUDA limitation documented, and the canonical MXFP4 GGUF
passed direct provenance plus dual-RTX-5090 runtime acceptance. This scope is
an audit record only. Follow-on expert selection must use
`.scopes/heretic-v2-reap96-consensus/` and cannot alter the frozen REAP132 plan
or canonical REAP132 artifacts.
